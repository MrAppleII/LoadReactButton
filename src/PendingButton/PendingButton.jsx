  ...
  PickSpinnerHeight = () => {
    if (this.menuWindow.current != null) {
     ...
     /* console.log(
        ~(
          window.innerHeight -
          this.menuWindow.current.getBoundingClientRect().top
        )
      )
      */
  ...
  render() {
    ...
    try {
      return this.props.isLoading ? (
        // This is the version for YES loading
        ...
        >
          <Holder>
            <ButtonText
              style={{ display: this.state.textVisible }}
              className={"left"}
            >
              {this.props.children}
            </ButtonText>
            <FadeInDiv>
              <OuterWrapper style={{display:this.state.spinnerVisible}} radius={spinnerRadius}>
        ...
        // This is the version for NOT loading
        <GenericButton
          ref={this.menuWindow}
          textcolor={this.props.textColor}
          color={this.props.buttonColor}
